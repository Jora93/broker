...
<div style="width: 100%">
    ...
    <table style="width:100%; border: 1px solid black; border-collapse: collapse; margin-top: 40px;">
        ...
        <tr>
            <td style="border-collapse: collapse;">{{$load->shipper_city}} {{$load->shipper_state}} {{$load->shipper_zip_code}}</td>
        ...
        @foreach($load->drops as $key => $drop)
            ...
            <tr>
                <td style="border-collapse: collapse;">{{$drop->city}} {{$drop->delivery_state}} {{$drop->delivery_location_zip_code}}</td>
