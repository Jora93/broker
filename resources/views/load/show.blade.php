                                                    ...
                                                    <div class="col-sm-6 col-xs-6" style="padding: 0">
                                                        <div class="col-sm-8 col-xs-8">
                                                            <div class="form-group">
                                                                ...
                                                                <input disabled type="text" name="shipper_pickup_time_from" class="form-control input-small time-picker-input" value="{{old('shipper_pickup_time_from', $load->shipper_pickup_time_from)}}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-6 col-xs-6" style="padding: 0">
                                                            <div class="col-sm-8 col-xs-8">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input disabled type="text" name="consignee[{{$key}}][delivery_time_from]" class="form-control input-small time-picker-input" value="{{$drop->delivery_time_from}}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
