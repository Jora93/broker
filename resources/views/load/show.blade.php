                                                    ...
                                                    <div class="col-sm-6 col-xs-6" style="padding: 0">
                                                        ...
                                                        <div class="col-sm-4 col-xs-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input disabled type="time" name="shipper_pickup_time_from" class="form-control input-small time-picker-input" value="{{old('shipper_pickup_time_from', $load->shipper_pickup_time_from)}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4 col-xs-4">
                                                            <div class="form-group">
                                                                <label class="control-label">To</label>
                                                                <input disabled type="time" name="shipper_pickup_time_to" class="form-control input-small time-picker-input" value="{{old('shipper_pickup_time_to', $load->shipper_pickup_time_to)}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4 col-xs-4">
                                                            <div class="form-group">
