...
@section('content')
    ...
    <div class="row customer-create col-sm-12">
        <form method="post" action="{{ url('/customers') }}" class="col-sm-12">
        @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" required="required" placeholder="Enter email" type="email" name="email" value="{{old('email')}}" id="customer_email" tabindex="27">
                            </div>
                        </div>
