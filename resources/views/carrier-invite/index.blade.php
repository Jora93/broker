        ...
        <div class="col-md-12">
            <div class="row justify-content-center">
                ...
                <div class="col-md-12">
                    ...
                    <form method="post" action={{ route('invite-carrier-create') }} enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="entityPanel entityFillPanel carrierPanel" >
                                <div class="entityPanelHeading">
                                    <div class="entityPanelTitle">*Documents</div>
                                </div>
                                <br>
                                <div class="entityPanelBody tabIndexContainer documentsContainer">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label class="form-label">Mc Authority</label>
                                            <input name="Mc Authority" class="form-control" style="padding: 3px" type="file" accept="image/*,application/pdf" required>
                                        </div>
                                        <div class="col-md-12">
                                            <label class="form-label">Insurance</label>
                                            <input name="Insurance" class="form-control" style="padding: 3px" type="file" accept="image/*,application/pdf" required>
                                        </div>
                                        <div class="col-md-12">
                                            <label class="form-label">W9</label>
                                            <input name="W9" class="form-control" style="padding: 3px" type="file" accept="image/*,application/pdf" required>
                                        </div>
                                        <div class="col-md-12">
                                            <label class="form-label">Payment document (NOA(Notice of Assignment) or Void Check)</label>
                                            <input name="Payment document" class="form-control" style="padding: 3px" type="file" accept="image/*,application/pdf" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <button type="submit" class="btn btn-primary" style="float: right; margin-right: 16px; margin-top: 10px;">Save</button>
                    </form>
                </div>
            </div>
        </div>
