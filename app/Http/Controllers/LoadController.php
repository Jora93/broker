...
class LoadController extends Controller
{
    ...
    public function store($company_id, Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            "shipper_payment_method" => ['nullable', 'string'],
            "shipper_quick_pay_percent" => ['nullable', 'integer'],
            "shipper_factoring" => ['nullable', 'string'],
            "shipper_factoring_ach_account_number" => ['nullable', 'string'],
            "shipper_factoring_ach_routing_number" => ['nullable', 'string'],
            "shipper_factoring_zelle_phone" => ['nullable', 'string'],
            "shipper_factoring_zelle_email" => ['nullable', 'string'],
